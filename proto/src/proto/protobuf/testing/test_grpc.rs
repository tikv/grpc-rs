...
const METHOD_TEST_SERVICE_EMPTY_CALL: ::grpcio::Method<super::empty::Empty, super::empty::Empty> =
    ::grpcio::Method {
...
const METHOD_TEST_SERVICE_CACHEABLE_UNARY_CALL: ::grpcio::Method<
    super::messages::SimpleRequest,
    super::messages::SimpleResponse,
> = ::grpcio::Method {
    ty: ::grpcio::MethodType::Unary,
...
const METHOD_TEST_SERVICE_STREAMING_INPUT_CALL: ::grpcio::Method<
    super::messages::StreamingInputCallRequest,
    super::messages::StreamingInputCallResponse,
> = ::grpcio::Method {
...
impl TestServiceClient {
    ...
    pub fn streaming_output_call_opt(
        &self,
        req: &super::messages::StreamingOutputCallRequest,
        opt: ::grpcio::CallOption,
    ) -> ::grpcio::Result<
        ::grpcio::ClientSStreamReceiver<super::messages::StreamingOutputCallResponse>,
    > {
        self.client
    ...
    pub fn streaming_input_call_opt(
        ...
        ::grpcio::ClientCStreamSender<super::messages::StreamingInputCallRequest>,
        ::grpcio::ClientCStreamReceiver<super::messages::StreamingInputCallResponse>,
    )> {
        self.client
    ...
    pub fn full_duplex_call_opt(
        ...
        ::grpcio::ClientDuplexSender<super::messages::StreamingOutputCallRequest>,
        ::grpcio::ClientDuplexReceiver<super::messages::StreamingOutputCallResponse>,
    )> {
        self.client
...
pub trait TestService {
    ...
    fn streaming_output_call(
        &mut self,
        ctx: ::grpcio::RpcContext,
        _req: super::messages::StreamingOutputCallRequest,
        sink: ::grpcio::ServerStreamingSink<super::messages::StreamingOutputCallResponse>,
    ) {
        grpcio::unimplemented_call!(ctx, sink)
    }
    fn streaming_input_call(
        &mut self,
        ctx: ::grpcio::RpcContext,
        _stream: ::grpcio::RequestStream<super::messages::StreamingInputCallRequest>,
        sink: ::grpcio::ClientStreamingSink<super::messages::StreamingInputCallResponse>,
    ) {
        grpcio::unimplemented_call!(ctx, sink)
    }
    fn full_duplex_call(
        &mut self,
        ctx: ::grpcio::RpcContext,
        _stream: ::grpcio::RequestStream<super::messages::StreamingOutputCallRequest>,
        sink: ::grpcio::DuplexSink<super::messages::StreamingOutputCallResponse>,
    ) {
        grpcio::unimplemented_call!(ctx, sink)
    }
    fn half_duplex_call(
...
#[cfg(feature = "offload-codec")]
pub fn create_test_service_offload<S: TestServiceOffload + Send + Clone + 'static>(
    s: S,
) -> ::grpcio::Service {
    let mut builder = ::grpcio::ServiceBuilder::new();
    let mut instance = s.clone();
...
#[cfg(feature = "offload-codec")]
pub fn create_unimplemented_service_offload<
    S: UnimplementedServiceOffload + Send + Clone + 'static,
>(
    s: S,
) -> ::grpcio::Service {
    let mut builder = ::grpcio::ServiceBuilder::new();
...
const METHOD_RECONNECT_SERVICE_START: ::grpcio::Method<
    super::messages::ReconnectParams,
    super::empty::Empty,
> = ::grpcio::Method {
    ty: ::grpcio::MethodType::Unary,
...
impl ReconnectServiceClient {
    ...
    pub fn start_opt(
        &self,
        req: &super::messages::ReconnectParams,
        opt: ::grpcio::CallOption,
    ) -> ::grpcio::Result<super::empty::Empty> {
        self.client
    ...
    pub fn stop_opt(
        ...
        req: &super::empty::Empty,
        opt: ::grpcio::CallOption,
    ) -> ::grpcio::Result<super::messages::ReconnectInfo> {
        self.client
    ...
    pub fn stop_async_opt(
        ...
        req: &super::empty::Empty,
        opt: ::grpcio::CallOption,
    ) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<super::messages::ReconnectInfo>> {
        self.client
...
pub trait ReconnectService {
    fn start(
        &mut self,
        ctx: ::grpcio::RpcContext,
        _req: super::messages::ReconnectParams,
        sink: ::grpcio::UnarySink<super::empty::Empty>,
    ) {
        grpcio::unimplemented_call!(ctx, sink)
    }
...
#[cfg(feature = "offload-codec")]
pub fn create_reconnect_service_offload<S: ReconnectServiceOffload + Send + Clone + 'static>(
    s: S,
) -> ::grpcio::Service {
    let mut builder = ::grpcio::ServiceBuilder::new();
    let mut instance = s.clone();
