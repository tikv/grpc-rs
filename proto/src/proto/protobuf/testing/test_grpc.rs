...
pub fn create_test_service<S: TestService + Send + Clone + 'static>(s: S) -> ::grpcio::Service {
    ...
    {
        builder = builder
            .add_unary_handler(&METHOD_TEST_SERVICE_EMPTY_CALL, move |ctx, req, resp| {
    ...
    {
        builder = builder
            .add_unary_handler(&METHOD_TEST_SERVICE_UNARY_CALL, move |ctx, req, resp| {
...
pub fn create_reconnect_service<S: ReconnectService + Send + Clone + 'static>(
    ...
    {
        builder = builder
            .add_unary_handler(&METHOD_RECONNECT_SERVICE_START, move |ctx, req, resp| {
    ...
    {
        builder = builder
            .add_unary_handler(&METHOD_RECONNECT_SERVICE_STOP, move |ctx, req, resp| {
