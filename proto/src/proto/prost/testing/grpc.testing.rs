...
impl ServerType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::SyncServer => "SYNC_SERVER",
            Self::AsyncServer => "ASYNC_SERVER",
            Self::AsyncGenericServer => "ASYNC_GENERIC_SERVER",
            Self::OtherServer => "OTHER_SERVER",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl RpcType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            Self::StreamingFromClient => "STREAMING_FROM_CLIENT",
            Self::StreamingFromServer => "STREAMING_FROM_SERVER",
            Self::StreamingBothWays => "STREAMING_BOTH_WAYS",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
const METHOD_BENCHMARK_SERVICE_UNARY_CALL_OFFLOAD: ::grpcio::Method<
    ::grpcio::pr_codec::Req<SimpleRequest>,
    ::grpcio::pr_codec::Resp<SimpleResponse>,
> = ::grpcio::Method {
    ty: ::grpcio::MethodType::Unary,
    name: "/grpc.testing.BenchmarkService/UnaryCall",
    req_mar: ::grpcio::Marshaller {
...
pub trait BenchmarkServiceOffload {
    fn unary_call(
        &mut self,
        ctx: ::grpcio::RpcContext,
        _req: ::grpcio::pr_codec::Req<SimpleRequest>,
        sink: ::grpcio::UnarySink<::grpcio::pr_codec::Resp<SimpleResponse>>,
    ) {
        grpcio::unimplemented_call!(ctx, sink)
    }
    fn streaming_call(
        &mut self,
        ctx: ::grpcio::RpcContext,
        _stream: ::grpcio::RequestStream<::grpcio::pr_codec::Req<SimpleRequest>>,
        sink: ::grpcio::DuplexSink<::grpcio::pr_codec::Resp<SimpleResponse>>,
    ) {
        grpcio::unimplemented_call!(ctx, sink)
    }
    fn streaming_from_client(
        ...
        ctx: ::grpcio::RpcContext,
        _stream: ::grpcio::RequestStream<::grpcio::pr_codec::Req<SimpleRequest>>,
        sink: ::grpcio::ClientStreamingSink<::grpcio::pr_codec::Resp<SimpleResponse>>,
    ) {
        grpcio::unimplemented_call!(ctx, sink)
    }
    fn streaming_from_server(
        ...
        ctx: ::grpcio::RpcContext,
        _req: ::grpcio::pr_codec::Req<SimpleRequest>,
        sink: ::grpcio::ServerStreamingSink<::grpcio::pr_codec::Resp<SimpleResponse>>,
    ) {
        grpcio::unimplemented_call!(ctx, sink)
    }
    fn streaming_both_ways(
...
const METHOD_WORKER_SERVICE_RUN_SERVER_OFFLOAD: ::grpcio::Method<
    ::grpcio::pr_codec::Req<ServerArgs>,
    ::grpcio::pr_codec::Resp<ServerStatus>,
> = ::grpcio::Method {
    ty: ::grpcio::MethodType::Duplex,
    name: "/grpc.testing.WorkerService/RunServer",
    req_mar: ::grpcio::Marshaller {
...
const METHOD_WORKER_SERVICE_RUN_CLIENT_OFFLOAD: ::grpcio::Method<
    ::grpcio::pr_codec::Req<ClientArgs>,
    ::grpcio::pr_codec::Resp<ClientStatus>,
> = ::grpcio::Method {
    ty: ::grpcio::MethodType::Duplex,
    name: "/grpc.testing.WorkerService/RunClient",
    req_mar: ::grpcio::Marshaller {
...
const METHOD_WORKER_SERVICE_CORE_COUNT_OFFLOAD: ::grpcio::Method<
    ::grpcio::pr_codec::Req<CoreRequest>,
    ::grpcio::pr_codec::Resp<CoreResponse>,
> = ::grpcio::Method {
    ty: ::grpcio::MethodType::Unary,
    name: "/grpc.testing.WorkerService/CoreCount",
    req_mar: ::grpcio::Marshaller {
...
const METHOD_WORKER_SERVICE_QUIT_WORKER_OFFLOAD: ::grpcio::Method<
    ::grpcio::pr_codec::Req<Void>,
    ::grpcio::pr_codec::Resp<Void>,
> = ::grpcio::Method {
    ty: ::grpcio::MethodType::Unary,
    name: "/grpc.testing.WorkerService/QuitWorker",
    req_mar: ::grpcio::Marshaller {
...
pub trait WorkerServiceOffload {
    fn run_server(
        &mut self,
        ctx: ::grpcio::RpcContext,
        _stream: ::grpcio::RequestStream<::grpcio::pr_codec::Req<ServerArgs>>,
        sink: ::grpcio::DuplexSink<::grpcio::pr_codec::Resp<ServerStatus>>,
    ) {
        grpcio::unimplemented_call!(ctx, sink)
    }
    fn run_client(
        &mut self,
        ctx: ::grpcio::RpcContext,
        _stream: ::grpcio::RequestStream<::grpcio::pr_codec::Req<ClientArgs>>,
        sink: ::grpcio::DuplexSink<::grpcio::pr_codec::Resp<ClientStatus>>,
    ) {
        grpcio::unimplemented_call!(ctx, sink)
    }
    fn core_count(
        &mut self,
        ctx: ::grpcio::RpcContext,
        _req: ::grpcio::pr_codec::Req<CoreRequest>,
        sink: ::grpcio::UnarySink<::grpcio::pr_codec::Resp<CoreResponse>>,
    ) {
        grpcio::unimplemented_call!(ctx, sink)
    }
    fn quit_worker(
        &mut self,
        ctx: ::grpcio::RpcContext,
        _req: ::grpcio::pr_codec::Req<Void>,
        sink: ::grpcio::UnarySink<::grpcio::pr_codec::Resp<Void>>,
    ) {
        grpcio::unimplemented_call!(ctx, sink)
    }
}
...
const METHOD_REPORT_QPS_SCENARIO_SERVICE_REPORT_SCENARIO_OFFLOAD: ::grpcio::Method<
    ::grpcio::pr_codec::Req<ScenarioResult>,
    ::grpcio::pr_codec::Resp<Void>,
> = ::grpcio::Method {
    ty: ::grpcio::MethodType::Unary,
    name: "/grpc.testing.ReportQpsScenarioService/ReportScenario",
...
pub trait ReportQpsScenarioServiceOffload {
    fn report_scenario(
        &mut self,
        ctx: ::grpcio::RpcContext,
        _req: ::grpcio::pr_codec::Req<ScenarioResult>,
        sink: ::grpcio::UnarySink<::grpcio::pr_codec::Resp<Void>>,
    ) {
        grpcio::unimplemented_call!(ctx, sink)
    }
...
const METHOD_TEST_SERVICE_EMPTY_CALL_OFFLOAD: ::grpcio::Method<
    ::grpcio::pr_codec::Req<Empty>,
    ::grpcio::pr_codec::Resp<Empty>,
> = ::grpcio::Method {
    ty: ::grpcio::MethodType::Unary,
    name: "/grpc.testing.TestService/EmptyCall",
    req_mar: ::grpcio::Marshaller {
...
const METHOD_TEST_SERVICE_STREAMING_OUTPUT_CALL_OFFLOAD: ::grpcio::Method<
    ::grpcio::pr_codec::Req<StreamingOutputCallRequest>,
    ::grpcio::pr_codec::Resp<StreamingOutputCallResponse>,
> = ::grpcio::Method {
    ty: ::grpcio::MethodType::ServerStreaming,
    name: "/grpc.testing.TestService/StreamingOutputCall",
    req_mar: ::grpcio::Marshaller {
...
const METHOD_TEST_SERVICE_STREAMING_INPUT_CALL_OFFLOAD: ::grpcio::Method<
    ::grpcio::pr_codec::Req<StreamingInputCallRequest>,
    ::grpcio::pr_codec::Resp<StreamingInputCallResponse>,
> = ::grpcio::Method {
    ty: ::grpcio::MethodType::ClientStreaming,
    name: "/grpc.testing.TestService/StreamingInputCall",
    req_mar: ::grpcio::Marshaller {
...
pub trait TestServiceOffload {
    fn empty_call(
        &mut self,
        ctx: ::grpcio::RpcContext,
        _req: ::grpcio::pr_codec::Req<Empty>,
        sink: ::grpcio::UnarySink<::grpcio::pr_codec::Resp<Empty>>,
    ) {
        grpcio::unimplemented_call!(ctx, sink)
    }
    fn unary_call(
    ...
    fn streaming_output_call(
        &mut self,
        ctx: ::grpcio::RpcContext,
        _req: ::grpcio::pr_codec::Req<StreamingOutputCallRequest>,
        sink: ::grpcio::ServerStreamingSink<::grpcio::pr_codec::Resp<StreamingOutputCallResponse>>,
    ) {
        grpcio::unimplemented_call!(ctx, sink)
    }
    fn streaming_input_call(
        &mut self,
        ctx: ::grpcio::RpcContext,
        _stream: ::grpcio::RequestStream<::grpcio::pr_codec::Req<StreamingInputCallRequest>>,
        sink: ::grpcio::ClientStreamingSink<::grpcio::pr_codec::Resp<StreamingInputCallResponse>>,
    ) {
        grpcio::unimplemented_call!(ctx, sink)
    }
    fn full_duplex_call(
        &mut self,
        ctx: ::grpcio::RpcContext,
        _stream: ::grpcio::RequestStream<::grpcio::pr_codec::Req<StreamingOutputCallRequest>>,
        sink: ::grpcio::DuplexSink<::grpcio::pr_codec::Resp<StreamingOutputCallResponse>>,
    ) {
        grpcio::unimplemented_call!(ctx, sink)
    }
    fn half_duplex_call(
...
const METHOD_RECONNECT_SERVICE_START_OFFLOAD: ::grpcio::Method<
    ::grpcio::pr_codec::Req<ReconnectParams>,
    ::grpcio::pr_codec::Resp<Empty>,
> = ::grpcio::Method {
    ty: ::grpcio::MethodType::Unary,
    name: "/grpc.testing.ReconnectService/Start",
...
const METHOD_RECONNECT_SERVICE_STOP_OFFLOAD: ::grpcio::Method<
    ::grpcio::pr_codec::Req<Empty>,
    ::grpcio::pr_codec::Resp<ReconnectInfo>,
> = ::grpcio::Method {
    ty: ::grpcio::MethodType::Unary,
    name: "/grpc.testing.ReconnectService/Stop",
    req_mar: ::grpcio::Marshaller {
...
pub trait ReconnectServiceOffload {
    fn start(
        &mut self,
        ctx: ::grpcio::RpcContext,
        _req: ::grpcio::pr_codec::Req<ReconnectParams>,
        sink: ::grpcio::UnarySink<::grpcio::pr_codec::Resp<Empty>>,
    ) {
        grpcio::unimplemented_call!(ctx, sink)
    }
    fn stop(
        ...
        ctx: ::grpcio::RpcContext,
        _req: ::grpcio::pr_codec::Req<Empty>,
        sink: ::grpcio::UnarySink<::grpcio::pr_codec::Resp<ReconnectInfo>>,
    ) {
        grpcio::unimplemented_call!(ctx, sink)
    }
}
