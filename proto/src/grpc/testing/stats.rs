...
pub struct ServerStats {
    ...
    pub core_stats: ::protobuf::SingularPtrField<super::super::core::stats::Stats>,
    // special fields
...
impl ServerStats {
    ...
    pub fn clear_core_stats(&mut self) {
        self.core_stats.clear();
    }

    pub fn has_core_stats(&self) -> bool {
        self.core_stats.is_some()
    }

    // Param is passed by value, moved
    pub fn set_core_stats(&mut self, v: super::super::core::stats::Stats) {
        self.core_stats = ::protobuf::SingularPtrField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_core_stats(&mut self) -> &mut super::super::core::stats::Stats {
        if self.core_stats.is_none() {
            self.core_stats.set_default();
        }
        self.core_stats.as_mut().unwrap()
    }

    // Take field
    pub fn take_core_stats(&mut self) -> super::super::core::stats::Stats {
        self.core_stats.take().unwrap_or_else(|| super::super::core::stats::Stats::new())
    }

    pub fn get_core_stats(&self) -> &super::super::core::stats::Stats {
        self.core_stats.as_ref().unwrap_or_else(|| super::super::core::stats::Stats::default_instance())
    }

    fn get_core_stats_for_reflect(&self) -> &::protobuf::SingularPtrField<super::super::core::stats::Stats> {
        &self.core_stats
    }

    fn mut_core_stats_for_reflect(&mut self) -> &mut ::protobuf::SingularPtrField<super::super::core::stats::Stats> {
        &mut self.core_stats
    }
}
...
impl ::protobuf::Message for ServerStats {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                7 => {
                    ::protobuf::rt::read_singular_message_into(wire_type, is, &mut self.core_stats)?;
                },
                _ => {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if let Some(ref v) = self.core_stats.as_ref() {
    ...
    fn descriptor_static(_: ::std::option::Option<ServerStats>) -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<super::super::core::stats::Stats>>(
                    "core_stats",
                    ServerStats::get_core_stats_for_reflect,
                    ServerStats::mut_core_stats_for_reflect,
                ));
    ...
    fn descriptor_static(_: ::std::option::Option<ClientStats>) -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<super::super::core::stats::Stats>>(
                    "core_stats",
                    ClientStats::get_core_stats_for_reflect,
                    ClientStats::mut_core_stats_for_reflect,
                ));
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x18grpc/testing/stats.proto\x12\x0cgrpc.testing\x1a\x15grpc/core/stat\
    s.proto\"\x8d\x02\n\x0bServerStats\x12!\n\x0ctime_elapsed\x18\x01\x20\
    \x01(\x01R\x0btimeElapsed\x12\x1b\n\ttime_user\x18\x02\x20\x01(\x01R\x08\
    timeUser\x12\x1f\n\x0btime_system\x18\x03\x20\x01(\x01R\ntimeSystem\x12$\
    \n\x0etotal_cpu_time\x18\x04\x20\x01(\x04R\x0ctotalCpuTime\x12\"\n\ridle\
    _cpu_time\x18\x05\x20\x01(\x04R\x0bidleCpuTime\x12\"\n\rcq_poll_count\
    \x18\x06\x20\x01(\x04R\x0bcqPollCount\x12/\n\ncore_stats\x18\x07\x20\x01\
    (\x0b2\x10.grpc.core.StatsR\tcoreStats\"T\n\x0fHistogramParams\x12\x1e\n\
    \nresolution\x18\x01\x20\x01(\x01R\nresolution\x12!\n\x0cmax_possible\
    \x18\x02\x20\x01(\x01R\x0bmaxPossible\"\xab\x01\n\rHistogramData\x12\x16\
    \n\x06bucket\x18\x01\x20\x03(\rR\x06bucket\x12\x19\n\x08min_seen\x18\x02\
    \x20\x01(\x01R\x07minSeen\x12\x19\n\x08max_seen\x18\x03\x20\x01(\x01R\
    \x07maxSeen\x12\x10\n\x03sum\x18\x04\x20\x01(\x01R\x03sum\x12$\n\x0esum_\
    of_squares\x18\x05\x20\x01(\x01R\x0csumOfSquares\x12\x14\n\x05count\x18\
    \x06\x20\x01(\x01R\x05count\"K\n\x12RequestResultCount\x12\x1f\n\x0bstat\
    us_code\x18\x01\x20\x01(\x05R\nstatusCode\x12\x14\n\x05count\x18\x02\x20\
    \x01(\x03R\x05count\"\xc9\x02\n\x0bClientStats\x129\n\tlatencies\x18\x01\
    \x20\x01(\x0b2\x1b.grpc.testing.HistogramDataR\tlatencies\x12!\n\x0ctime\
    _elapsed\x18\x02\x20\x01(\x01R\x0btimeElapsed\x12\x1b\n\ttime_user\x18\
    \x03\x20\x01(\x01R\x08timeUser\x12\x1f\n\x0btime_system\x18\x04\x20\x01(\
    \x01R\ntimeSystem\x12I\n\x0frequest_results\x18\x05\x20\x03(\x0b2\x20.gr\
    pc.testing.RequestResultCountR\x0erequestResults\x12\"\n\rcq_poll_count\
    \x18\x06\x20\x01(\x04R\x0bcqPollCount\x12/\n\ncore_stats\x18\x07\x20\x01\
    (\x0b2\x10.grpc.core.StatsR\tcoreStatsJ\x9e\x19\n\x06\x12\x04\x0e\0R\x01\
    \n\xbf\x04\n\x01\x0c\x12\x03\x0e\0\x122\xb4\x04\x20Copyright\x202015\x20\
    ...
    \x02\x03\0\x12\x03\x12\x07\x1e\n\n\n\x02\x04\0\x12\x04\x14\0*\x01\n\n\n\
    \x03\x04\0\x01\x12\x03\x14\x08\x13\nA\n\x04\x04\0\x02\0\x12\x03\x16\x02\
    \x1a\x1a4\x20wall\x20clock\x20time\x20change\x20in\x20seconds\x20since\
    \x20last\x20reset\n\n\r\n\x05\x04\0\x02\0\x04\x12\x04\x16\x02\x14\x15\n\
    \x0c\n\x05\x04\0\x02\0\x05\x12\x03\x16\x02\x08\n\x0c\n\x05\x04\0\x02\0\
    \x01\x12\x03\x16\t\x15\n\x0c\n\x05\x04\0\x02\0\x03\x12\x03\x16\x18\x19\n\
    S\n\x04\x04\0\x02\x01\x12\x03\x19\x02\x17\x1aF\x20change\x20in\x20user\
    \x20time\x20(in\x20seconds)\x20used\x20by\x20the\x20server\x20since\x20l\
    ast\x20reset\n\n\r\n\x05\x04\0\x02\x01\x04\x12\x04\x19\x02\x16\x1a\n\x0c\
    \n\x05\x04\0\x02\x01\x05\x12\x03\x19\x02\x08\n\x0c\n\x05\x04\0\x02\x01\
    \x01\x12\x03\x19\t\x12\n\x0c\n\x05\x04\0\x02\x01\x03\x12\x03\x19\x15\x16\
    \nn\n\x04\x04\0\x02\x02\x12\x03\x1d\x02\x19\x1aa\x20change\x20in\x20serv\
    er\x20time\x20(in\x20seconds)\x20used\x20by\x20the\x20server\x20process\
    \x20and\x20all\n\x20threads\x20since\x20last\x20reset\n\n\r\n\x05\x04\0\
    \x02\x02\x04\x12\x04\x1d\x02\x19\x17\n\x0c\n\x05\x04\0\x02\x02\x05\x12\
    \x03\x1d\x02\x08\n\x0c\n\x05\x04\0\x02\x02\x01\x12\x03\x1d\t\x14\n\x0c\n\
    \x05\x04\0\x02\x02\x03\x12\x03\x1d\x17\x18\nK\n\x04\x04\0\x02\x03\x12\
    \x03\x20\x02\x1c\x1a>\x20change\x20in\x20total\x20cpu\x20time\x20of\x20t\
    he\x20server\x20(data\x20from\x20proc/stat)\n\n\r\n\x05\x04\0\x02\x03\
    \x04\x12\x04\x20\x02\x1d\x19\n\x0c\n\x05\x04\0\x02\x03\x05\x12\x03\x20\
    \x02\x08\n\x0c\n\x05\x04\0\x02\x03\x01\x12\x03\x20\t\x17\n\x0c\n\x05\x04\
    \0\x02\x03\x03\x12\x03\x20\x1a\x1b\nF\n\x04\x04\0\x02\x04\x12\x03#\x02\
    \x1b\x1a9\x20change\x20in\x20idle\x20time\x20of\x20the\x20server\x20(dat\
    a\x20from\x20proc/stat)\n\n\r\n\x05\x04\0\x02\x04\x04\x12\x04#\x02\x20\
    ...
    \x03\x12\x03&\x19\x1a\n!\n\x04\x04\0\x02\x06\x12\x03)\x02!\x1a\x14\x20Co\
    re\x20library\x20stats\n\n\r\n\x05\x04\0\x02\x06\x04\x12\x04)\x02&\x1b\n\
    \x0c\n\x05\x04\0\x02\x06\x06\x12\x03)\x02\x11\n\x0c\n\x05\x04\0\x02\x06\
    \x01\x12\x03)\x12\x1c\n\x0c\n\x05\x04\0\x02\x06\x03\x12\x03)\x1f\x20\n@\
    \n\x02\x04\x01\x12\x04-\00\x01\x1a4\x20Histogram\x20params\x20based\x20o\
    n\x20grpc/support/histogram.c\n\n\n\n\x03\x04\x01\x01\x12\x03-\x08\x17\n\
    ...
    \n5\n\x04\x04\x01\x02\x01\x12\x03/\x02\x1a\"(\x20use\x20enough\x20bucket\
    s\x20to\x20allow\x20this\x20value\n\n\r\n\x05\x04\x01\x02\x01\x04\x12\
    \x04/\x02.\x18\n\x0c\n\x05\x04\x01\x02\x01\x05\x12\x03/\x02\x08\n\x0c\n\
    \x05\x04\x01\x02\x01\x01\x12\x03/\t\x15\n\x0c\n\x05\x04\x01\x02\x01\x03\
    \x12\x03/\x18\x19\n>\n\x02\x04\x02\x12\x043\0:\x01\x1a2\x20Histogram\x20\
    data\x20based\x20on\x20grpc/support/histogram.c\n\n\n\n\x03\x04\x02\x01\
    \x12\x033\x08\x15\n\x0b\n\x04\x04\x02\x02\0\x12\x034\x02\x1d\n\x0c\n\x05\
    \x04\x02\x02\0\x04\x12\x034\x02\n\n\x0c\n\x05\x04\x02\x02\0\x05\x12\x034\
    \x0b\x11\n\x0c\n\x05\x04\x02\x02\0\x01\x12\x034\x12\x18\n\x0c\n\x05\x04\
    \x02\x02\0\x03\x12\x034\x1b\x1c\n\x0b\n\x04\x04\x02\x02\x01\x12\x035\x02\
    \x16\n\r\n\x05\x04\x02\x02\x01\x04\x12\x045\x024\x1d\n\x0c\n\x05\x04\x02\
    \x02\x01\x05\x12\x035\x02\x08\n\x0c\n\x05\x04\x02\x02\x01\x01\x12\x035\t\
    \x11\n\x0c\n\x05\x04\x02\x02\x01\x03\x12\