...
impl GreeterClient {
    ...
    pub fn say_hello_async_opt(&self, req: &super::helloworld::HelloRequest, opt: ::grpcio::CallOption) -> ::grpcio::ClientUnaryReceiver<super::helloworld::HelloReply> {
        self.client.unary_call_async(&METHOD_GREETER_SAY_HELLO, req, opt)
    }

    pub fn say_hello_async(&self, req: &super::helloworld::HelloRequest) -> ::grpcio::ClientUnaryReceiver<super::helloworld::HelloReply> {
...
pub trait Greeter {
    fn say_hello(&self, ctx: ::grpcio::RpcContext, req: super::helloworld::HelloRequest, sink: ::grpcio::UnarySink<super::helloworld::HelloReply>);
}
