...
impl RouteGuideClient {
    ...
    pub fn get_feature_async_opt(&self, req: &super::route_guide::Point, opt: ::grpcio::CallOption) -> ::grpcio::ClientUnaryReceiver<super::route_guide::Feature> {
        self.client.unary_call_async(&METHOD_ROUTE_GUIDE_GET_FEATURE, req, opt)
    }

    pub fn get_feature_async(&self, req: &super::route_guide::Point) -> ::grpcio::ClientUnaryReceiver<super::route_guide::Feature> {
        self.get_feature_async_opt(req, ::grpcio::CallOption::default())
    }

    pub fn list_features_opt(&self, req: &super::route_guide::Rectangle, opt: ::grpcio::CallOption) -> ::grpcio::ClientSStreamReceiver<super::route_guide::Feature> {
        self.client.server_streaming(&METHOD_ROUTE_GUIDE_LIST_FEATURES, req, opt)
    }

    pub fn list_features(&self, req: &super::route_guide::Rectangle) -> ::grpcio::ClientSStreamReceiver<super::route_guide::Feature> {
        self.list_features_opt(req, ::grpcio::CallOption::default())
    }

    pub fn record_route_opt(&self, opt: ::grpcio::CallOption) -> (::grpcio::ClientCStreamSender<super::route_guide::Point>, ::grpcio::ClientCStreamReceiver<super::route_guide::RouteSummary>) {
        self.client.client_streaming(&METHOD_ROUTE_GUIDE_RECORD_ROUTE, opt)
    }

    pub fn record_route(&self) -> (::grpcio::ClientCStreamSender<super::route_guide::Point>, ::grpcio::ClientCStreamReceiver<super::route_guide::RouteSummary>) {
        self.record_route_opt(::grpcio::CallOption::default())
    }

    pub fn route_chat_opt(&self, opt: ::grpcio::CallOption) -> (::grpcio::ClientDuplexSender<super::route_guide::RouteNote>, ::grpcio::ClientDuplexReceiver<super::route_guide::RouteNote>) {
        self.client.duplex_streaming(&METHOD_ROUTE_GUIDE_ROUTE_CHAT, opt)
    }

    pub fn route_chat(&self) -> (::grpcio::ClientDuplexSender<super::route_guide::RouteNote>, ::grpcio::ClientDuplexReceiver<super::route_guide::RouteNote>) {
...
pub trait RouteGuide {
    fn get_feature(&self, ctx: ::grpcio::RpcContext, req: super::route_guide::Point, sink: ::grpcio::UnarySink<super::route_guide::Feature>);
    fn list_features(&self, ctx: ::grpcio::RpcContext, req: super::route_guide::Rectangle, sink: ::grpcio::ServerStreamingSink<super::route_guide::Feature>);
    fn record_route(&self, ctx: ::grpcio::RpcContext, stream: ::grpcio::RequestStream<super::route_guide::Point>, sink: ::grpcio::ClientStreamingSink<super::route_guide::RouteSummary>);
    fn route_chat(&self, ctx: ::grpcio::RpcContext, stream: ::grpcio::RequestStream<super::route_guide::RouteNote>, sink: ::grpcio::DuplexSink<super::route_guide::RouteNote>);
}
