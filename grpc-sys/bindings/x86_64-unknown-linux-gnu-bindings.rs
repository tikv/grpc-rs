...
pub const GRPC_USE_CPP_STD_LIB: u32 = 1;
...
#[doc = " A struct containing all information necessary to schedule/cancel"]
#[doc = "a credential reload request. cb and cb_user_data represent a gRPC-provided"]
#[doc = "callback and an argument passed to it. key_materials is an in/output"]
#[doc = "parameter containing currently used/newly reloaded credentials. If"]
#[doc = "credential reload does not result in a new credential, key_materials should"]
#[doc = "not be modified. status and error_details are used to hold information about"]
#[doc = "errors occurred when a credential reload request is scheduled/cancelled. It"]
...
#[doc = "authorization check request. cb and cb_user_data represent a gRPC-provided"]
#[doc = "callback and an argument passed to it. success will store the result of"]
#[doc = "server authorization check. That is, if success returns a non-zero value, it"]
#[doc = "means the authorization check passes and if returning zero, it means the"]
#[doc = "check fails. target_name is the name of an endpoint the channel is connecting"]
#[doc = "to and certificate represents a complete certificate chain including both"]
#[doc = "signing and leaf certificates. status and error_details contain information"]
#[doc = "about errors occurred when a server authorization check request is"]
#[doc = "scheduled/cancelled. It is used for experimental purpose for now and subject"]
#[doc = "to change."]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
