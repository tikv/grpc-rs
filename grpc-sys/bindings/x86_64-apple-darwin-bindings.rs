...
#[doc = "It is cheap to take references to a slice, and it is cheap to create a"]
#[doc = "slice pointing to a subset of another slice."]
#[doc = ""]
#[doc = "The data-structure for slices is exposed here to allow non-gpr code to"]
#[doc = "build slices from whatever data they have available."]
#[doc = ""]
#[doc = "When defining interfaces that handle slices, care should be taken to define"]
...
pub struct grpc_slice_refcount_vtable {
    ...
    pub eq: ::std::option::Option<
        unsafe extern "C" fn(a: grpc_slice, b: grpc_slice) -> ::std::os::raw::c_int,
    >,
    pub hash: ::std::option::Option<unsafe extern "C" fn(slice: grpc_slice) -> u32>,
}
#[test]
fn bindgen_test_layout_grpc_slice_refcount_vtable() {
    assert_eq!(
        ::std::mem::size_of::<grpc_slice_refcount_vtable>(),
        32usize,
        concat!("Size of: ", stringify!(grpc_slice_refcount_vtable))
    );
    assert_eq!(
        ::std::mem::align_of::<grpc_slice_refcount_vtable>(),
        8usize,
        concat!("Alignment of ", stringify!(grpc_slice_refcount_vtable))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<grpc_slice_refcount_vtable>())).ref_ as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(grpc_slice_refcount_vtable),
            "::",
            stringify!(ref_)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<grpc_slice_refcount_vtable>())).unref as *const _ as usize
        },
        8usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<grpc_slice_refcount_vtable>())).eq as *const _ as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(grpc_slice_refcount_vtable),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<grpc_slice_refcount_vtable>())).hash as *const _ as usize },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(grpc_slice_refcount_vtable),
...
#[doc = " Reference count container for grpc_slice. Contains function pointers to"]
#[doc = "increment and decrement reference counts. Implementations should cleanup"]
#[doc = "when the reference count drops to zero."]
#[doc = "Typically client code should not touch this, and use grpc_slice_malloc,"]
#[doc = "grpc_slice_new, or grpc_slice_new_with_len instead."]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct grpc_slice_refcount {
    pub vtable: *const grpc_slice_refcount_vtable,
    #[doc = " If a subset of this slice is taken, use this pointer for the refcount."]
    #[doc = "Typically points back to the refcount itself, however iterning"]
    #[doc = "implementations can use this to avoid a verification step on each hash"]
    #[doc = "or equality check"]
    pub sub_refcount: *mut grpc_slice_refcount,
}
#[test]
fn bindgen_test_layout_grpc_slice_refcount() {
    assert_eq!(
        ::std::mem::size_of::<grpc_slice_refcount>(),
        16usize,
        concat!("Size of: ", stringify!(grpc_slice_refcount))
    );
    assert_eq!(
        ::std::mem::align_of::<grpc_slice_refcount>(),
        8usize,
        concat!("Alignment of ", stringify!(grpc_slice_refcount))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<grpc_slice_refcount>())).vtable as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(grpc_slice_refcount),
            "::",
            stringify!(vtable)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<grpc_slice_refcount>())).sub_refcount as *const _ as usize
        },
        8usize,
        concat!(
            "Offset of field: ",
...
#[repr(C)]
pub struct grpc_byte_buffer_grpc_byte_buffer_data {
    pub reserved: __BindgenUnionField<grpc_byte_buffer_grpc_byte_buffer_data__bindgen_ty_1>,
    pub raw: __BindgenUnionField<grpc_byte_buffer_grpc_byte_buffer_data_grpc_compressed_buffer>,
    pub bindgen_union_field: [u64; 38usize],
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub struct grpc_event {
    ...
    #[doc = "Only GRPC_OP_COMPLETE has a tag."]
...
extern "C" {
    ...
    #[doc = "grpc_init()."]
    #[doc = ""]
    #[doc = "No memory is used by grpc after this call returns, nor are any instructions"]
    #[doc = "executing within the grpc library."]
    #[doc = "Prior to calling, all application owned grpc objects must have been"]
    #[doc = "destroyed."]
...
extern "C" {
    #[doc = " Called by clients to cancel an RPC on the server."]
...
pub enum grpc_ssl_client_certificate_request_type {
    ...
    #[doc = "certificate."]
    #[doc = ""]
    #[doc = "The cerificate presented by the client is verified by the gRPC framework."]
...
#[repr(u32)]
#[doc = " Type of local connection for which local channel/server credentials will be"]
#[doc = " applied. It only supports UDS for now."]
#[derive(Debug, Copy, Clone, PartialEq, Eq, Hash)]
...
extern "C" {
    ...
    #[doc = "aquired by an out of band mechanism."]
...
extern "C" {
    ...
    #[doc = "authenticate client cerificates."]
...
extern "C" {
    #[link_name = "\u{1}__Z45grpcwrap_metadata_array_destroy_metadata_onlyP19grpc_metadata_array"]
    pub fn grpcwrap_metadata_array_destroy_metadata_only(array: *mut grpc_metadata_array);
}
extern "C" {
    #[link_name = "\u{1}__Z58grpcwrap_metadata_array_destroy_metadata_including_entriesP19grpc_metadata_array"]
...
extern "C" {
    #[link_name = "\u{1}__Z28grpcwrap_metadata_array_moveP19grpc_metadata_arrayS0_"]
